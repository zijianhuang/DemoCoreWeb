...
export namespace Core3WebApi_Controllers_Client {
	export class Statistics {
		...
		getDistribution(): Promise<AxiosResponse> {
			return Axios.get(this.baseUri + 'api/Statistics/distribution');
		}
	}
...
export namespace DemoCoreWeb_Controllers_Client {
	export class SpecialTypes {
		...
		getAnonymousDynamic(): Promise<AxiosResponse> {
			return Axios.get(this.baseUri + 'api/SpecialTypes/AnonymousDynamic');
		}
		...
		getAnonymousObject(): Promise<AxiosResponse> {
			return Axios.get(this.baseUri + 'api/SpecialTypes/AnonymousObject');
		}
...
export namespace DemoWebApi_Controllers_Client {
	export class Entities {
		...
		getCompany(id: number): Promise<DemoWebApi_DemoData_Client.Company> {
			return Axios.get<DemoWebApi_DemoData_Client.Company>(this.baseUri + 'api/Entities/Company/' + id).then(d => d.data);
		}
		...
		getPerson(id: number): Promise<DemoWebApi_DemoData_Client.Person> {
			return Axios.get<DemoWebApi_DemoData_Client.Person>(this.baseUri + 'api/Entities/getPerson/' + id).then(d => d.data);
		}
	...
	export class Heroes {
		...
		post(name: string): Promise<DemoWebApi_Controllers_Client.Hero> {
			return Axios.post<DemoWebApi_Controllers_Client.Hero>(this.baseUri + 'api/Heroes', JSON.stringify(name), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
		...
		search(name: string): Promise<Array<DemoWebApi_Controllers_Client.Hero>> {
			return Axios.get<Array<DemoWebApi_Controllers_Client.Hero>>(this.baseUri + 'api/Heroes/search/' + (name == null ? '' : encodeURIComponent(name))).then(d => d.data);
		}
	}
	...
	export class Home {
		...
		index(): Promise<AxiosResponse<Blob>> {
			return Axios.get(this.baseUri + 'api/Home', { responseType: 'blob' }).then(d => d.data);
		}
	}
	...
	export class SuperDemo {
		...
		getDateTime(hasValue: boolean): Promise<Date> {
			return Axios.get<Date>(this.baseUri + 'api/SuperDemo/NullableDatetime/' + hasValue).then(d => d.data);
		}
		...
		getDecimalSquare(d: number): Promise<number> {
			return Axios.get<number>(this.baseUri + 'api/SuperDemo/decimal/' + d).then(d => d.data);
		}
		...
		getIntSquare(d: number): Promise<number> {
			return Axios.get<number>(this.baseUri + 'api/SuperDemo/int/' + d).then(d => d.data);
		}
		...
		getNextHour(dt: Date): Promise<Date> {
			return Axios.get<Date>(this.baseUri + 'api/SuperDemo/NextHour/' + dt.toISOString()).then(d => d.data);
		}
		...
		getNextYear(dt: Date): Promise<Date> {
			return Axios.get<Date>(this.baseUri + 'api/SuperDemo/NextYear/' + dt.toISOString()).then(d => d.data);
		}
		...
		getNullableDecimal(hasValue: boolean): Promise<number> {
			return Axios.get<number>(this.baseUri + 'api/SuperDemo/NullableDecimal/' + hasValue).then(d => d.data);
		}
		...
		postWithQueryButEmptyBody(s: string, i: number): Promise<{item1: string, item2: number}> {
			return Axios.post<{item1: string, item2: number}>(this.baseUri + 'api/SuperDemo/PostEmpty/' + i, JSON.stringify(s), { headers: { 'Content-Type': 'application/json;charset=UTF-8' } }).then(d => d.data);
		}
