...
export namespace DemoWebApi_Controllers_Client {
	...
	export class DateTypes {
		 ...
		 */
		postDateTimeNullable(d: Date | null, headersHandler?: () => HttpHeaders): Observable<Date> {
			return this.http.post<Date>(this.baseUri + 'api/DateTypes/DateTimeNullable', JSON.stringify(d), { headers: headersHandler ? headersHandler().append('Content-Type', 'application/json;charset=UTF-8') : new HttpHeaders({ 'Content-Type': 'application/json;charset=UTF-8' }) });
		}
	...
	export class Heroes {
		 ...
		 * @param {string} id Type: long, -9,223,372,036,854,775,808 to 9,223,372,036,854,775,807
		 */
		getSuperHero(id: string | null, headersHandler?: () => HttpHeaders): Observable<DemoWebApi_Controllers_Client.SuperHero> {
			return this.http.get<DemoWebApi_Controllers_Client.SuperHero>(this.baseUri + 'api/Heroes/super?id=' + id, { headers: headersHandler ? headersHandler() : undefined });
		}
	...
	export class Numbers {
		 ...
		 * @return {number} Type: byte, 0 to 255
		 */
		postByDOfnumber(d: number | null, headersHandler?: () => HttpHeaders): Observable<number> {
		 ...
		 * @return {string} Type: long, -9,223,372,036,854,775,808 to 9,223,372,036,854,775,807
		 */
		postByDOfstring(d: string | null, headersHandler?: () => HttpHeaders): Observable<string> {
	...
	export class TextData {
		 ...
		 */
		getNullableString(headersHandler?: () => HttpHeaders): Observable<string> {
