...
namespace DemoWebApi.Controllers.Client
{
    ...
    public partial class Heroes
    {
        ...
        /// GET api/Heroes
        /// </summary>
        public async Task<DemoWebApi.Controllers.Hero[]> GetAsync()
        {
            ...
            {
            var serializer = new JsonSerializer();
            return serializer.Deserialize<DemoWebApi.Controllers.Hero[]>(jsonReader);
            }
        }
        ...
        /// GET api/Heroes
        /// </summary>
        public DemoWebApi.Controllers.Hero[] Get()
        {
            var requestUri = new Uri(this.baseUri, "api/Heroes");
            var responseMessage = this.client.GetAsync(requestUri).Result;
            responseMessage.EnsureSuccessStatusCode();
        ...
        /// GET api/Heroes/{id}
        /// </summary>
        public async Task<DemoWebApi.Controllers.Hero> GetAsync(long id)
        {
            var requestUri = new Uri(this.baseUri, "api/Heroes/"+id);
            var responseMessage = await client.GetAsync(requestUri);
            responseMessage.EnsureSuccessStatusCode();
        ...
        /// GET api/Heroes/{id}
        /// </summary>
        public DemoWebApi.Controllers.Hero Get(long id)
        {
            var requestUri = new Uri(this.baseUri, "api/Heroes/"+id);
            var responseMessage = this.client.GetAsync(requestUri).Result;
            responseMessage.EnsureSuccessStatusCode();
        ...
        /// POST api/Heroes
        /// </summary>
        public async Task<DemoWebApi.Controllers.Hero> PostAsync(string name)
        {
            var requestUri = new Uri(this.baseUri, "api/Heroes");
            using (var requestWriter = new System.IO.StringWriter())
			{
        ...
        /// POST api/Heroes
        /// </summary>
        public DemoWebApi.Controllers.Hero Post(string name)
        {
            var requestUri = new Uri(this.baseUri, "api/Heroes");
            using (var requestWriter = new System.IO.StringWriter())
			{
        ...
        /// </summary>
        public async Task<DemoWebApi.Controllers.Hero> PostWithQueryAsync(string name)
        {
        ...
        /// POST api/Heroes/q?name={name}
        /// </summary>
        public DemoWebApi.Controllers.Hero PostWithQuery(string name)
        {
            var requestUri = new Uri(this.baseUri, "api/Heroes/q?name="+Uri.EscapeDataString(name));
        ...
        /// PUT api/Heroes
        /// </summary>
        public async Task<DemoWebApi.Controllers.Hero> PutAsync(DemoWebApi.Controllers.Hero hero)
        {
            var requestUri = new Uri(this.baseUri, "api/Heroes");
            using (var requestWriter = new System.IO.StringWriter())
			{
        ...
        /// PUT api/Heroes
        /// </summary>
        public DemoWebApi.Controllers.Hero Put(DemoWebApi.Controllers.Hero hero)
        {
            var requestUri = new Uri(this.baseUri, "api/Heroes");
            using (var requestWriter = new System.IO.StringWriter())
			{
        ...
        /// </summary>
        public async Task<DemoWebApi.Controllers.Hero[]> SearchAsync(string name)
        {
        ...
        /// GET api/Heroes/search/{name}
        /// </summary>
        public DemoWebApi.Controllers.Hero[] Search(string name)
        {
            var requestUri = new Uri(this.baseUri, "api/Heroes/search/"+Uri.EscapeDataString(name));
            var responseMessage = this.client.GetAsync(requestUri).Result;
            responseMessage.EnsureSuccessStatusCode();
