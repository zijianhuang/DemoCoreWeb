...
describe('SuperDemo API', () => {
  ...
  it('getTextStream', async () => {
    ...
    console.debug('data: ' + JSON.stringify( data)); // abcdefg
    console.debug('data.statusText: ' + data.statusText);
	//to be fixed by https://github.com/zijianhuang/webapiclientgen/issues/131
    //console.debug('data.text: ' + await data.data.text());
    expect(data.status).toBe(200);
    //expect(await data.data.text()).toBe('"abcdefg"');
